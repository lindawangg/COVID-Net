...
parser.add_argument('--file', default='hospital_data.txt', type=str, help='Path to train file')
parser.add_argument('--name', default='COVIDNet', type=str, help='Name of folder to store training checkpoints')
parser.add_argument('--datadir', default='hospital_images', type=str, help='Path to data folder')
