...
parser.add_argument('--trainfile', default='labels/train_COVIDx_CXR-3B.txt', type=str, help='Path to train file')
parser.add_argument('--testfile', default='labels/test_COVIDx_CXR-3B.txt', type=str, help='Path to test file')
