...
parser.add_argument('--metaname', default='model-b-3.meta', type=str, help='Name of ckpt meta file')
parser.add_argument('--ckptname', default='model-b-3', type=str, help='Name of model ckpts')
