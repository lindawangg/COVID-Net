# COVIDx CXR Dataset
**Update 06/02/2022: Released a cleaned training dataset (COVIDx CXR-3) with several hundred training images removed which were not representative of typical CXRs. The [new dataset](https://www.kaggle.com/datasets/andyczhao/covidx-cxr2/versions/7) contains 29,986 images from 16,648 patients.**\
**Update 11/28/2021: Released a new training dataset with over 30,000 CXR images from a multinational cohort of over 16,400 patients. The dataset contains 16,490 positive COVID-19 images from over 2,800 patients. The COVIDx V9A dataset is for detection of no pneumonia/non-COVID-19 pneumonia/COVID-19 pneumonia, and COVIDx V9B dataset is for COVID-19 positive/negative detection.**\
